...
<link rel="import" id="recommendL" href="http://localhost/PHP/Thesis/Learning/logfile/AprioriF.php">
...
<ul class="bar">
  ...
  <li id="bUAgentTab" onclick="switchA()"><a id="#5" href="#Blank user agent.php" target="bUAgent" >Blank User Agent</a></li>
   ...
   <li id="mostRecentTab" onclick="switchA()"><a id="#8" href="#Most Recent.php" target="mostRecent" >Most recent visits</a></li>
    <li id="mostRecomTab" onclick="switchA()"><a id="#9" href="#Apriori.php" target="recommend" ></a></li>
...
<script>
  ...
  var getImport  = document.querySelector('#recommendL');
  var getContent = getImport.import.querySelector('#aprioriId');
  document.getElementById("9").appendChild(getContent);
